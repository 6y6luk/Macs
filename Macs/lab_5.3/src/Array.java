public class Array {
    ...
    //--- FIND ELEMENTS INDEX
    //
    public int getIndex(byte[] array, byte key) {
        int firstIndex = 0;
    ...
    public int getIndex(short[] array, short key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
    ...
    public int getIndex(long[] array, long key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
    ...
    public int getIndex(float[] array, float key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
    ...
    public int getIndex(double[] array, double key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
    ...
    public int getIndex(char[] array, char key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;

        while(firstIndex <= lastIndex) {
            int middleIndex = (firstIndex + lastIndex) / 2;
            if (array[middleIndex] - '0' == key - '0') {
                return middleIndex;
            }

            else if (array[middleIndex] - '0' < key - '0')
                firstIndex = middleIndex + 1;
    ...
    //--- ELEMET AVAILABLE
    //
    public boolean Available(byte[] array, byte key) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] == key) {
                return true;
            }
    ...
    public boolean Available(short[] array, short key) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] == key) {
                return true;
            }
    ...
    public boolean Available(int[] array, int key) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] == key) {
                return true;
            }
    ...
    public boolean Available(long[] array, long key) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] == key) {
                return true;
            }
    ...
    public boolean Available(float[] array, float key) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] == key) {
                return true;
            }
    ...
    public boolean Available(double[] array, double key) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] == key) {
                return true;
            }
    ...
    public boolean Available(char[] array, char key) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] == key) {
                return true;
            }
    ...
    public boolean Available(String[] array, String key) {
        for (int i = 0; i < array.length; i++) {
            if (array[i] == key) {
                return true;
            }
    ...
    //--- BINARY SEARCH
    //
    public int binarySearch(byte[] array, byte key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
    ...
    public int binarySearch(short[] array, short key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
    ...
    public int binarySearch(float[] array, float key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
    ...
    public int binarySearch(double[] array, double key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
    ...
    public int binarySearch(char[] array, char key) {
        int firstIndex = 0;
        int lastIndex = array.length - 1;
